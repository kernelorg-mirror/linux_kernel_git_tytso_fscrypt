...
static int ext4_set_verity(struct inode *inode, loff_t data_i_size)
{
	...
	/* Remove extents past EOF; see ext4_get_verity_metadata_end() */
 ...
 */
static int ext4_get_verity_metadata_end(struct inode *inode,
					loff_t *metadata_end_ret)
{
...
static struct page *ext4_read_verity_metadata_page(struct inode *inode,
						   pgoff_t index)
{
